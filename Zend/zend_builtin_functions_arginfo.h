 ...
 * Stub hash: 1746b40bf9c6f97bae4a631cea5aa13e4094ec0d */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_print, 0, 1, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, expression, IS_MIXED, 0)
ZEND_END_ARG_INFO()
